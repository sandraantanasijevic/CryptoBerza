...
│                   SERVER                            │
│  ┌──────────────┐  ┌─────────────┐  ┌───────────┐   │
│  │ExchangeServic│  │MarketEngine │  │TcpServer  │   │
...
│           ├── MarketDisplay.java
│           └── ConsoleColors.java
├── bin/                   ← Kompajlirani .class fajlovi 
├── build.bat              ← Kompajliranje
├── run_server.bat         ← Pokretanje servera
├── run_client.bat         ← Pokretanje klijenta
└── run_bots.bat           ← Pokretanje botova
